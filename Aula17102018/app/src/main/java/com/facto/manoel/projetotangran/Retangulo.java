...
//    public Retangulo(GL10 gl, int posX, int posY, int largura, int altura){
//        super(gl,posX,posY, largura,altura);
//    }
//
//    public Retangulo(GL10 gl, int largura, int altura) {
//        super(gl, largura, altura);
//    }
//
//    public void setCordenadas() {
//        float [] retangulo = {
//                -getLargura()/4,-getAltura()/4,
//                getLargura()/4,-getAltura()/4,
//                -getLargura()/4,getAltura()/2,
//                getLargura()/4,getAltura()/2
//        };
//        this.buffer = criaBuffer(retangulo);
